...
namespace PushButton
{
    ...
    void Handle_setAutoDefault__wrapper() {
        auto _this = Handle__pop();
        auto value = ni_popBool();
        Handle_setAutoDefault(_this, value);
    }

    void Handle_setDefault__wrapper() {
        auto _this = Handle__pop();
        auto value = ni_popBool();
        Handle_setDefault(_this, value);
    }

    void Handle_setFlat__wrapper() {
        auto _this = Handle__pop();
        auto value = ni_popBool();
        Handle_setFlat(_this, value);
    }
    ...
    int __register() {
        ...
        ni_registerModuleMethod(m, "Handle_setAutoDefault", &Handle_setAutoDefault__wrapper);
        ni_registerModuleMethod(m, "Handle_setDefault", &Handle_setDefault__wrapper);
