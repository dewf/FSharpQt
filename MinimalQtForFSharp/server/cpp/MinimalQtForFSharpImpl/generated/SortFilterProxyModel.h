...
namespace SortFilterProxyModel
{
    ...
    public:
        ...
        virtual void filterCaseSensitivityChanged(CaseSensitivity filterCaseSensitivity) = 0;
        virtual void filterRoleChanged(ItemDataRole filterRole) = 0;
        virtual void recursiveFilteringEnabledChanged(bool recursiveFilteringEnabled) = 0;
        virtual void sortCaseSensitivityChanged(CaseSensitivity sortCaseSensitivity) = 0;
        virtual void sortLocaleAwareChanged(bool sortLocaleAware) = 0;
        virtual void sortRoleChanged(ItemDataRole sortRole) = 0;
    };
