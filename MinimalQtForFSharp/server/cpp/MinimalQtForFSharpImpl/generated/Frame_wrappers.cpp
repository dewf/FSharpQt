...
namespace Frame
{
    ...
    void Handle_setFrameRect__wrapper() {
        ...
        auto rect = Rect__pop();
        Handle_setFrameRect(_this, rect);
    }

    void Handle_setFrameShadow__wrapper() {
        auto _this = Handle__pop();
        auto shadow = Shadow__pop();
        Handle_setFrameShadow(_this, shadow);
    }

    void Handle_setFrameShape__wrapper() {
        auto _this = Handle__pop();
        auto shape = Shape__pop();
        Handle_setFrameShape(_this, shape);
    }

    void Handle_frameWidth__wrapper() {
        auto _this = Handle__pop();
        ni_pushInt32(Handle_frameWidth(_this));
    }

    void Handle_setLineWidth__wrapper() {
        auto _this = Handle__pop();
        auto width = ni_popInt32();
        Handle_setLineWidth(_this, width);
    }

    void Handle_setMidLineWidth__wrapper() {
        auto _this = Handle__pop();
        auto width = ni_popInt32();
        Handle_setMidLineWidth(_this, width);
    }
    ...
    void Handle_setFrameStyle__wrapper() {
        ...
        auto shape = Shape__pop();
        auto shadow = Shadow__pop();
        Handle_setFrameStyle(_this, shape, shadow);
    }
    ...
    int __register() {
        auto m = ni_registerModule("Frame");
        ni_registerModuleMethod(m, "create", &create__wrapper);
        ni_registerModuleMethod(m, "Handle_setFrameRect", &Handle_setFrameRect__wrapper);
        ni_registerModuleMethod(m, "Handle_setFrameShadow", &Handle_setFrameShadow__wrapper);
        ni_registerModuleMethod(m, "Handle_setFrameShape", &Handle_setFrameShape__wrapper);
        ni_registerModuleMethod(m, "Handle_frameWidth", &Handle_frameWidth__wrapper);
        ni_registerModuleMethod(m, "Handle_setLineWidth", &Handle_setLineWidth__wrapper);
        ni_registerModuleMethod(m, "Handle_setMidLineWidth", &Handle_setMidLineWidth__wrapper);
        ni_registerModuleMethod(m, "Handle_setFrameStyle", &Handle_setFrameStyle__wrapper);
